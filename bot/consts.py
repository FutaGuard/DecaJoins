...
📝 使用方法如下
/doh -s <doh 伺服器 網域> -q <查詢網域> -t <查詢類型> -b <測速> -R\
<留空表示輸出原始內容，不輸入則簡短輸出>
範例： /doh -s https://doh.futa.gg/dns-query -q google.com -t A

/dig -s <dns 伺服器 ip> -q <查詢網域> -t <查詢類型> -b <測速> -R <留空表示輸出原始內容\
，不輸入則簡短輸出>
範例： /dig -s 1.1.1.1 -q google.com -t NS -b 5

/doq -s <doq 伺服器 網域> -q <查詢網域> -p <連接埠> -t <查詢類型> -b <測速> -R\
<留空表示輸出原始內容，不輸入則簡短輸出>
...
⚡ 關於作者
作者是 @kachowlife 並獨立經營 @FutaGuard 頻道，如果喜歡的話不妨點及追蹤，\
同時本機器人所有原始碼均開源在 https://github.com/FutaGuard/DecaJoins
喜歡的話歡迎也對 Repo 點擊 ⭐ Star，同時推薦你到 https://service.futa.gg \
看更多好玩的東西\
'''
